...
def predict():
    if request.method == 'POST':
        ...
        if prediction==1:
             return render_template('index.html',prediction_text="Customer will leave the Bank.")
        else:
             return render_template('index.html',prediction_text="Customer will not leave the bank")
